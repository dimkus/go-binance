...
[![Build Status](https://travis-ci.org/dimkus/go-binance.svg?branch=master)](https://travis-ci.org/dimkus/go-binance)
[![GoDoc](https://godoc.org/github.com/dimkus/go-binance?status.svg)](https://godoc.org/github.com/dimkus/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/dimkus/go-binance)](https://goreportcard.com/report/github.com/dimkus/go-binance)
[![codecov](https://codecov.io/gh/dimkus/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/dimkus/go-binance)
...
```shell
go get github.com/dimkus/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/dimkus/go-binance/v1
```
...
import (
    ...
    "github.com/dimkus/go-binance/v2"
    
    "github.com/dimkus/go-binance/v2/futures" // optional package
    "github.com/dimkus/go-binance/v2/delivery" // optional package
    "github.com/dimkus/go-binance/v2/options" // optional package
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/dimkus/go-binance) for full references.
...
```go
import (
    "github.com/dimkus/go-binance/v2/futures"
)
...
```go
import (
    "github.com/dimkus/go-binance/v2/delivery"
)
